    ...
    <div className="text-white p-2 md:p-4 lg:p-6 shadow-xl w-full">
      ...
      >
        <div className="flex items-center mb-4 md:mb-6 w-full max-w-xs rounded-full border border-gray-700 backdrop-blur-3xl space-x-2 px-2 py-0.5">
          <img className="p-1 rounded-full h-6 w-6 sm:h-8 sm:w-8 md:h-12 md:w-12" src={AiIcon} alt="AI Icon" />
          <h2 className="text-xs sm:text-sm md:text-xl font-gilroy font-semibold truncate">Trending Stocks</h2>
        </div>
        <div className="mb-3 md:mb-4 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
          <div className="flex justify-between text-xs md:text-base font-medium min-w-max">
            {TABS.map((tab) => {
              ...
              return (
                <button
                  key={tab.key}
                  className={`flex items-center gap-1 text-xs sm:text-sm md:text-lg font-gilroy font-bold pb-1 sm:pb-2 border-b-2 mx-2 sm:mx-4 transition-colors ${
                    isActive
        ...
        <div className="overflow-x-auto rounded-xl scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
      <div className="min-w-[520px]">
        <div className="relative">
          <div className="bg-[#48387B] absolute inset-0 z-0 rounded-t-xl"></div>
          <div className="grid grid-cols-12 gap-1 px-2 py-3 text-[11px] sm:text-xs md:text-sm font-semibold relative z-10">
        ...
        <div className="max-h-80 overflow-y-auto rounded-b-xl scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
          {stocks.map((stock, index) => (
            <div
              key={index}
              className="grid grid-cols-12 gap-1 px-2 py-3 items-center text-[11px] sm:text-xs md:text-sm hover:bg-[#2a1c45] transition-colors"
            >
              <div className="col-span-5 sm:col-span-4 flex items-center gap-2 font-gilroy font-semibold">
              ...
              <div className="col-span-2 sm:col-span-2 flex justify-center sm:justify-start">
                <span
                  className={`px-2 py-0.5 rounded text-[10px] sm:text-xs font-semibold inline-flex items-center gap-1 ${
