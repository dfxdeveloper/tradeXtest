...
export default function SampleReportModal({ isOpen, onClose }) {
  ...
  const handleDownload = async (e) => {
    ...
    try {
      ...
      link.href = "/TradeXpertSampleStrategyBacktestingReport.pdf";
      link.download = "TradeXpert-Sample-Strategy-Backtesting-Report.pdf";
