...
const StatsCard = ({ number, label }) => (
  <div className="about_cardbg p-8 rounded-2xl backdrop-blur-sm w-full flex flex-col items-center h-[180px]">
    <h2 className="text-4xl font-bold text-white font-gilroy text-center mt-6">{number}</h2>
    <p className="text-[#A7ADBE] mt-4 font-gilroy font-bold text-center text-sm">{label}</p>
  </div>
);
...
const WhoWeAre = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0E0018] mb-16 lg:mb-0 about_whoweare flex items-center py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col justify-center">
            <div>
              <span className="inline-block bg-[#170026] text-[#B039FF] font-gilroy font-semibold text-xs px-4 py-2.5 rounded-full mb-6 border border-[#6A11CB]">
                Results & Analytics
              </span>
            </div>

            <h1 className="text-3xl sm:text-4xl font-gilroy font-boldtext-white mb-6">
              Shaping the Future with Transformative Results
            </h1>

            <p className="text-[#E9D7FE] font-gilroy font-semibold leading-relaxed text-sm sm:text-base opacity-80">
              ...
              industry. With every project, we push boundaries, turning
