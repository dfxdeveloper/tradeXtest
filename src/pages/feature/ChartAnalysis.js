...
const ChartAnalysis = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#1f0322] to-[#281f4b] text-white font-euclid min-h-screen py-12">
      <div className="text-center mb-12">
        ...
        <div className="inline-flex rounded-full border border-[#2F2F6A] p-1 gap-1 mb-10">
          <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {currentContent.map((item, index) => (
            <div key={index} className="bg-[#2f1b43] p-6 rounded-lg shadow-lg text-center">
              <img src={item.img} alt={item.title} className="mx-auto mb-4 rounded" />
